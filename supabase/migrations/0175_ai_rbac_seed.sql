...
--    (2026-07-03). José Luis NO existe en profiles → pendiente de alta por
--    flujo normal; NO se inserta a mano ni se inventa email.
...
where lower(p.email) in (
  ...
  -- José Luis: PENDIENTE de alta por flujo normal (no existe en profiles al
  -- momento de esta migración). Agregarlo acá en una migración posterior.
)
