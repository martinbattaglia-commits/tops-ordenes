...
export default defineConfig({
  ...
  test: {
    include: [
      ...
      "src/app/auth/reset-password/**/*.test.ts",
      "src/app/auth/recovery/**/*.test.ts",
      "src/app/auth/invite/**/*.test.{ts,tsx}",
      "src/app/auth/recovery/**/*.test.{ts,tsx}",
      "src/app/**/settings/users/**/*.test.{ts,tsx}",
      "src/app/auth/forgot-password/**/*.test.ts",
      "src/app/login/**/*.test.ts",
