...
export const metadata = { title: "Flujo de fondos · Finanzas" };
export const dynamic = "force-dynamic";

export default async function FlujoFondosFinanzasPage() {
  try {
    ...
    return (
      <div className="p-4 lg:p-8 nx-page-fade">
        <div className="page-header">
          <div>
            <div className="eyebrow-tiny">Finanzas · Tesorería Integrada</div>
