...
import { listBankAccounts, listMovements } from "@/lib/tesoreria/data";
...
export default async function MovimientoOperativoPage() {
  try {
    ...
    const operativos = movements.filter((m) => m.type === "movimiento_operativo").slice(0, 20);
    ...
    return (
      <div className="p-4 lg:p-8 nx-page-fade">
        <div className="page-header">
          <div>
            ...
            <p className="page-subtitle">
              Registrá movimientos de Tesorería que no provienen de un pago a proveedor: adelantos,
              reintegros, regularizaciones y gastos operativos. Las transferencias entre cuentas usan
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          <MovimientoOperativoForm accounts={activeAccounts} />
          ...
          <div className="card p-5">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {operativos.length === 0 && (
                  <tr><td colSpan={6} className="py-4 text-fg-muted">Sin movimientos operativos aún.</td></tr>
                )}
                {operativos.map((m) => (
    ...
    return (
      <ModuleUnavailable
        ...
        migration="0190_treasury_operational_movements"
