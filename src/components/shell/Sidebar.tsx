...
const DOMAINS: Domain[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/contabilidad/resultado-cc", label: "Resultado por centro", icon: "trend-up" },
      { href: "/contabilidad/centros-costo", label: "Centros de costo", icon: "tag-alt" },
      { href: "/contabilidad/ordenes-facturar", label: "Órdenes a facturar", icon: "package" },
      { href: "/contabilidad/servicios", label: "Servicios facturables", icon: "tag-alt" },
      { href: "/contabilidad/tarifas", label: "Tarifas por cliente", icon: "tag-alt" },
      { href: "/contabilidad/billing", label: "Facturación recurrente", icon: "refresh" },
      { href: "/contabilidad/pricing-logistica", label: "Pricing logístico", icon: "calculator" },
      { href: "/contabilidad/cierre", label: "Cierre de períodos", icon: "lock" },
      { href: "/contabilidad/refundicion-anual", label: "Refundición anual", icon: "lock" },
