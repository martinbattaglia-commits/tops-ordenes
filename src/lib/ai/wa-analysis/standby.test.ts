...
describe("S4 · el cierre es quirúrgico", () => {
  ...
  it("NADA se borró: código, contrato, esquema y tests del analizador siguen enteros", () => {
    // El cierre es una pausa, no una amputación. Si alguien «limpiara» el analizador,
    // esto se pone rojo.
    for (const f of [
      "src/lib/ai/wa-analysis/analyze.ts",
      ...
      "supabase/migrations/0213_ai_suggestions.sql",
      "supabase/migrations/0214_ai_budget_alerts.sql",
      "supabase/migrations/0215_ai_audit_retention.sql",
      "supabase/migrations/0216_ai_grants_hardening.sql",
      "supabase/migrations/0217_ai_run_lifecycle.sql",
      "supabase/migrations/0218_ai_usage_breakdown.sql",
    ]) {
