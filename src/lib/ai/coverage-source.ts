...
export const COPILOT_COVERAGE: CoverageRow[] = [
  ...
  { modulo: "Conocimiento institucional (web TOPS)", estado: "brecha", fuente: "sin ingesta conectada", ruta: "", detalle: "Brecha de cobertura: el contenido institucional de Logística TOPS (logisticatops.com, landing de Cargas Generales, landing de productos regulados/ANMAT — URLs a confirmar) todavía no está ingestado como fuente consultable del Copilot. Diseño propuesto: ingesta controlada al spine documental existente (requiere OK y migración).", keywords: "institucional web sitio pagina servicios propuesta comercial valor landing cargas generales regulados vendemos diferenciadores discurso trabaja tops" },
