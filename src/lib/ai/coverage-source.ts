...
export const COPILOT_COVERAGE: CoverageRow[] = [
  ...
  // ── Pirámide de conocimiento (2026-07-07): capas 2-4 ───────────────────────
  { modulo: "Conocimiento institucional (web TOPS)", estado: "brecha", fuente: "capa diseñada (company_knowledge_search / mig 0185), sin documentos ingestados", ruta: "", detalle: "Brecha de cobertura: la capa institucional está DISEÑADA (tabla company_knowledge_documents + tool company_knowledge_search, migración 0185) pero todavía no tiene documentos ingestados. El contenido institucional de Logística TOPS (logisticatops.com, landing de Cargas Generales, landing de productos regulados/ANMAT, dossiers, propuestas, código de ética) se ingiere desde una carpeta Knowledge Base de Drive. Para responder con contenido real: aplicar 0185 + curar e ingerir los documentos.", keywords: "institucional web sitio pagina servicios propuesta comercial valor landing cargas generales regulados vendemos diferenciadores discurso trabaja tops dossier etica identidad" },
  { modulo: "NotebookLM · investigaciones y capacitaciones", estado: "brecha", fuente: "sin conector en el runtime de la app", ruta: "", detalle: "Brecha de cobertura: los cuadernos de NotebookLM (investigaciones, trabajos de campo, capacitaciones internas, FDA/ANMAT, benchmarks) no tienen conector disponible en la app. Alternativas: exportar los cuadernos a Drive e ingestarlos por la proyección documental existente, o un conector dedicado cuando exista.", keywords: "notebooklm investigacion investigaciones capacitacion capacitaciones formacion material campo benchmark mejores practicas fda aprendimos" },
  { modulo: "Actualidad externa (dólar, noticias, clima, inflación)", estado: "brecha", fuente: "sin proveedor externo conectado", ruta: "", detalle: "Brecha de cobertura: cotizaciones, noticias, clima e inflación requieren una fuente externa en tiempo real (BCRA/proveedor FX, news API, INDEC o Gemini con grounding). El Copilot declara la limitación y no inventa valores actuales.", keywords: "dolar cotizacion noticias clima inflacion actualidad tiempo real economia" },
];
