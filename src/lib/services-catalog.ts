...
export const SERVICES_CATALOG: ServiceCatalogItem[] = [
  ...
  // ---- Almacenamiento -------------------------------------------------------
  // Almacenamiento por m²: no hay tarifa general aprobada. La unidad y el
  // concepto pueden seleccionarse, pero la emisión exige un precio particular
  // vigente y autorizado para el cliente. Nunca se convierte una referencia
  // USD a ARS de forma implícita.
  {
    id: "s-alm-general",
    slug: "alm-general",
    ...
    rate: null,
    requires_quote: true,
    observ: "A COTIZAR · requiere precio particular aprobado para el cliente.",
    icon: "building",
    active: true,
  },
  {
