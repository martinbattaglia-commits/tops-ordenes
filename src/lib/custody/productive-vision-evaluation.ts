...
// El sniffer vive en un módulo PURO: mantenerlo acá metía el proveedor de
// visión en el grafo de todo el que registra evidencia. Ver `vision-mime.ts`.
import { sniffCustodyVisionMime } from "./vision-mime";
export { sniffCustodyVisionMime } from "./vision-mime";
